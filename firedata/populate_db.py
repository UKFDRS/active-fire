...
class ProcSQL(prepare.PrepData):
    ...
    def dataframe_to_db(self, dfr):
        ...
        for nr, chunk in enumerate(dfrs):
            ...
            print("The time of execution of get active is :", (end - start), "s")
            ...
            print("The time of execution of events prep is :", (end - start), "s")
            start = time.time()
            self.db.insert_events(events_chunk.values.tolist())
            end = time.time()
            print("The time of execution of events insert is :", (end - start), "s")
            ...
            print("The time of execution of insert active is :", (end - start), "s")
            ...
            print("The time of execution of insert extinct is :", (end - start), "s")
            print("TOTAL time is :", (end - start_g), "s")
